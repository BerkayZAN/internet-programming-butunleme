...
$id=$_GET['id'];
$hizmetdetay=$db->query("select * from hizmetler where id='$id'")->fetch(PDO::FETCH_ASSOC);
?>
...
<title><?=$hizmetdetay['adi']?> - <?=$ayar['site_title']?></title>
...
<div class="subheader normal-bg section-padding">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h1 class="text-custom-white"><?=$hizmetdetay['adi']?></h1>
        <ul class="custom-flex justify-content-center">
          <li class="fw-500"> <a href="./" class="text-custom-white">Anasayfa</a> </li>
          <li class="active fw-500"> <?=$hizmetdetay['adi']?> </li>
        </ul>
      </div>
    </div>
  </div>
        ...
        <div class="blog-details bx-wrapper bg-custom-white padding-20">
          <article class="post p-relative">
            <div class="post-wrapper">
              <div class="post-img animate-img mb-xl-20"> <img src="lib/images/hizmetler/<?=$hizmetdetay['resim']?>" class="image-fit" alt="img"> </div>
              <div class="blog-meta bg-custom-white">
               
                <div class="post-heading p-relative">
                  <h2><a href="#" class="text-custom-black"><?=$hizmetdetay['adi']?></a></h2>
                </div>
               
                <p class="text-light-dark"><?=$hizmetdetay['aciklama']?></p>
              </div>
            </div>
          </article>
          <hr>
