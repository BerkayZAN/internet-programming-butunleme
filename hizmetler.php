...
<div class="subheader normal-bg section-padding">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h1 class="text-custom-white">Hizmetler</h1>
        <ul class="custom-flex justify-content-center">
          <li class="fw-500"> <a href="./" class="text-custom-white">Anasayfa</a> </li>
          <li class="active fw-500"> Hizmetler </li>
        </ul>
      </div>
    </div>
  </div>
...
<?php
$hizmetler=$db->query("select * from hizmetler where durum='0'",PDO::FETCH_ASSOC);
...
?>
      <article class="col-lg-4 col-md-6 post mb-xl-30">
        <div class="post-wrapper bx-wrapper">
          <div class="post-img animate-img"> <a href="#"> <img src="lib/images/hizmetler/<?=$h['resim']?>" style="width:100%;height:250px;" class="full-width" alt="<?=$h['adi']?>"> </a>
           
          </div>
          <div class="blog-meta padding-20 bg-custom-white p-relative">
               <div class="post-heading">
              <h2> <a href="#" class="text-custom-black fw-600 fs-20"><?=$h['adi']?> </a> </h2>
              <p class="text-light-dark no-margin"><?=substr($h['aciklama'],0,200)?></p>
            </div>
          </div>
          <div class="post-footer">
           
            <a href="blog-details.html" class="btn-first btn-submit fs-14 fs-600">İnceleyin</a> </div>
        </div>
      </article>
   <?php } } ?>
    </div>
