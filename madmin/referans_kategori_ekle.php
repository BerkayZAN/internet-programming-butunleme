...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$klasor="../lib/images/referans_kategori/";
	...
	$klasor_banner="../lib/images/referans_kategori/";
...
if(empty($kategori_adi)){
	...
	$query=$db->prepare("insert into referans_kategori set
						sira				= :sira,
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	{
		$duzenlenecek_id = $_GET['id'];
		$ayar_kaydi = $db->query("SELECT * FROM referans_kategori WHERE id = '$duzenlenecek_id'")->fetch(PDO::FETCH_ASSOC);
	...
	else
	{
		if ($_FILES["kategori_resim"]["type"] =="image/gif" || $_FILES["kategori_resim"]["type"] =="image/png"|| $_FILES["kategori_resim"]["type"] =="image/jpg"|| $_FILES["kategori_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/referans_kategori/".$ayar_kaydi['kategori_resim']);	  
			}
	...
	else
	{
		if ($_FILES["banner_resim"]["type"] =="image/gif" || $_FILES["banner_resim"]["type"] =="image/png"|| $_FILES["banner_resim"]["type"] =="image/jpg"|| $_FILES["banner_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/referans_kategori/".$ayar_kaydi['banner_resim']);	  
			}
	...
	$update = $db->prepare("UPDATE referans_kategori SET 
						sira				= :sira,
						kategori_adi		= :kategori_adi,
						site_title			= :site_title,
						site_description	= :site_description,
...
{
	$id=$_GET['id'];
	$guncelle_dizi = $db->query("SELECT * FROM referans_kategori where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="">Referans Kategori Ekle</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary col-md-12">
            <div class="box-header with-border">
              <h3 class="box-title">Referans Kategori Ekle</h3>
              <?=$bilgi?>
            </div>            
            ...
            <div class="tab-content col-md-12">
             ...
             <div class="form-group col-md-12">
                            ...
                            <select class="form-control select2" name="ustid">
                             ...
                             <?php $kategori_cek=$db->query("select * from referans_kategori where ustid='0'",PDO::FETCH_ASSOC);
                            ...
                            <option value="<?=$kategori_dizi['id']?>" <?php if($kategori_dizi['id']==$guncelle_dizi['ustid']) { ?> selected="selected" <?php } ?>><?=$kategori_dizi['kategori_adi']?></option>
                                     ...
                                     <?php $ustid = $kategori_dizi['id'];
                                            $kategori_cek1=$db->query("select * from referans_kategori where ustid='$ustid'",PDO::FETCH_ASSOC);
        ...
        <?php }?>  
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/referans_kategori/<?=$guncelle_dizi['kategori_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/referans_kategori/".$guncelle_dizi['kategori_resim']);
						}
						}
					?>
				</div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/referans_kategori/<?=$guncelle_dizi['banner_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill_banner"]){
							 unlink("../lib/images/referans_kategori/".$guncelle_dizi['banner_resim']);
						}
						}
					?>
				</div>
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Kategori Açıklama</label>
           	  ...
           	  <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Kategori Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Kategori Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-12">
                  ...
                  <label for="exampleInputEmail1">Referans Kategori Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Kategori Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Referans Kategori Açıklama Almanca</label>
