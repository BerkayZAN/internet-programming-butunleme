                    ...
                    <tr>
                      ...
                      <td>
					  	<?php 
							...
							$kategori_sorgu=$db->query("select * from haber_kategori where id='$urun_id'");
                     ...
                     <a href='haber_ekle.php?islem=duzenle&id=<?=$sonuc['id']?>' class='btn btn-primary m-r1em'>Düzenle</a>
