...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$klasor="../lib/images/hizmet_kategori/";
	...
	$klasor_banner="../lib/images/hizmet_kategori/";
...
if(empty($kategori_adi)){
	...
	$query=$db->prepare("insert into hizmet_kategori set
						sira				= :sira,
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	{
		$duzenlenecek_id = $_GET['id'];
		$ayar_kaydi = $db->query("SELECT * FROM hizmet_kategori WHERE id = '$duzenlenecek_id'")->fetch(PDO::FETCH_ASSOC);
	...
	else
	{
		if ($_FILES["kategori_resim"]["type"] =="image/gif" || $_FILES["kategori_resim"]["type"] =="image/png"|| $_FILES["kategori_resim"]["type"] =="image/jpg"|| $_FILES["kategori_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/hizmet_kategori/".$ayar_kaydi['kategori_resim']);	  
			}
	...
	else
	{
		if ($_FILES["banner_resim"]["type"] =="image/gif" || $_FILES["banner_resim"]["type"] =="image/png"|| $_FILES["banner_resim"]["type"] =="image/jpg"|| $_FILES["banner_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/hizmet_kategori/".$ayar_kaydi['banner_resim']);	  
			}
	...
	$update = $db->prepare("UPDATE hizmet_kategori SET 
						sira				= :sira,
						kategori_adi		= :kategori_adi,
						site_title 			= :site_title,
						site_description	= :site_description,
...
{
	$id=$_GET['id'];
	$guncelle_dizi = $db->query("SELECT * FROM hizmet_kategori where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="">Hizmet Kategori Ekle</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary col-md-12">
            <div class="box-header with-border">
              <h3 class="box-title">Hizmet Kategori Ekle</h3>
              <?=$bilgi?>
            </div>            
    ...
    <option style="background:#555; color:#fff;" value="<?=$kategori_dizii['id']?>" <?php if($kategori_dizii['id']==$guncelle_dizi['ustid']){?> selected="selected"<?php } ?>><span style="font-size:10px; color:#039;"> - - > <?=$kategori_dizii['kategori_adi']?> - <?=$kategori_dizii['id']?></span></option>     
    			...
    			<?php $ustidd = $kategori_dizii['id'];
					$kategori_cekk=$db->query("select * from hizmet_kategori where ustid='$ustidd' order by sira asc",PDO::FETCH_ASSOC);
    ...
    <option style="background:#888; color:#000;" value="<?=$kategori_dizim['id']?>" <?php if($kategori_dizim['id']==$guncelle_dizi['ustid']){?> selected="selected"<?php } ?>><span style="font-size:10px;"> - - - > <?=$kategori_dizim['kategori_adi']?> - <?=$kategori_dizim['id']?></span></option>    
					...
					$kategori_cek3=$db->query("select * from hizmet_kategori where ustid='$ustiddd' order by sira asc",PDO::FETCH_ASSOC);
    ...
    <option style="background:#ccc; color:#000;" value="<?=$kategori_dizi3['id']?>" <?php if($kategori_dizi3['id']==$guncelle_dizi['ustid']){?> selected="selected"<?php } ?>><span style="font-size:10px; "> - - - - > <?=$kategori_dizi3['kategori_adi']?> - <?=$kategori_dizi3['id']?></span></option>  
					...
					$kategori_cek4=$db->query("select * from hizmet_kategori where ustid='$ustidddd' order by sira asc",PDO::FETCH_ASSOC);
    ...
    <option style="background:#eee; color:#000;" value="<?=$kategori_dizi4['id']?>" <?php if($kategori_dizi4['id']==$guncelle_dizi['ustid']){?> selected="selected"<?php } ?>><span style="font-size:10px; "> - - - - - > <?=$kategori_dizi4['kategori_adi']?> - <?=$kategori_dizi4['id']?></span></option>                      
        ...
        <?php }?>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/hizmet_kategori/<?=$guncelle_dizi['kategori_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/hizmet_kategori/".$guncelle_dizi['kategori_resim']);
						}
						}
					?>
				</div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/hizmet_kategori/<?=$guncelle_dizi['banner_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill_banner"]){
							 unlink("../lib/images/hizmet_kategori/".$guncelle_dizi['banner_resim']);
						}
						}
					?>
				</div>
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama</label>
         ...
         <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Hizmet Kategori Açıklama Almanca</label>
