...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$adi_de	=	$_POST['adi_de'];
	$durum	=	$_POST['durum'];	
	$sube_telefon	=	$_POST['sube_telefon'];
	...
	$klasor_banner="../lib/images/subeler/";
...
if(empty($adi)){
	...
	$query=$db->prepare("insert into subeler set
		sira	= :sira,
		adi		= :adi,
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	{
		$duzenlenecek_id = $_GET['id'];
		$ayar_kaydi = $db->query("SELECT * FROM subeler WHERE id = '$duzenlenecek_id'")->fetch(PDO::FETCH_ASSOC);
	...
	else
	{
		if ($_FILES["resim"]["type"] =="image/gif" || $_FILES["resim"]["type"] =="image/png"|| $_FILES["resim"]["type"] =="image/jpg"|| $_FILES["resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/subeler/".$ayar_kaydi['resim']);	  
			}
	...
	else
	{
		if ($_FILES["banner_resim"]["type"] =="image/gif" || $_FILES["banner_resim"]["type"] =="image/png"|| $_FILES["banner_resim"]["type"] =="image/jpg"|| $_FILES["banner_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/subeler/".$ayar_kaydi['banner_resim']);	  
			}
	...
	$update = $db->prepare("UPDATE subeler SET 
							sira	= :sira,
							adi		= :adi,
							site_title		= :site_title,
							site_description	= :site_description,
...
{
	$id=$_GET['id'];
	$guncelle_dizi = $db->query("SELECT * FROM subeler Where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
$id_bul = $db->query("SELECT * FROM subeler order by id desc LIMIT 1")->fetch(PDO::FETCH_ASSOC);
$idim=$id_bul['id']+1;
?>
<!DOCTYPE html>
<html>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-home"></i> AnaŞube</a></li>
        <li><a href="">Şube Ekle</a></li>
      </ol>
    </section>
          ...
          <div class="box box-primary col-md-12">
           ...
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="dr "><a href="#tab_2" data-toggle="tab">Şube Resimleri</a></li>
            ...
            <div class="tab-content col-md-12">
              ...
              <div class="tab-pane active" id="tab_1">
               <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Sırası</label>
                  <input type="text" class="form-control" name="sira" value="<?=$guncelle_dizi['sira']?>">
                </div>
                
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Adı</label>
                  <input type="text" class="form-control" name="adi" id="adi" value="<?=$guncelle_dizi['adi']?>" >
                </div>
                
                
                <?php if($yonetici_izin["en"]==0){?>            
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube fax</label>
                  <input type="text" class="form-control" name="adi_en" value="<?=$guncelle_dizi['adi_en']?>" >
                </div>
        <?php }?>
        <?php if($yonetici_izin["fr"]==0){?> 
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube e mail</label>
                  <input type="text" class="form-control" name="adi_fr" value="<?=$guncelle_dizi['adi_fr']?>" >
                </div>
        <?php }?>
        <?php if($yonetici_izin["ar"]==0){?>         
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Web site</label>
                  <input type="text" class="form-control" name="adi_ar" value="<?=$guncelle_dizi['adi_ar']?>" >
                </div>
        <?php }?>
        <?php if($yonetici_izin["ru"]==1){?>         
				<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Adı Rusça</label>
                  <input type="text" class="form-control" name="adi_ru" value="<?=$guncelle_dizi['adi_ru']?>" >
                </div>
        <?php }?>
        <?php if($yonetici_izin["de"]==1){?>        
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Adı Almanca</label>
                  <input type="text" class="form-control" name="adi_de" value="<?=$guncelle_dizi['adi_de']?>" >
                </div>
        <?php }?> 
        
        		<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Telefon Numarası</label>
                  <input type="text" class="form-control" name="sube_telefon" value="<?=$guncelle_dizi['sube_telefon']?>" >
                </div>
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Adresi</label>
                  <input type="text" class="form-control" name="sube_adres" value="<?=$guncelle_dizi['sube_adres']?>" >
                </div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/subeler/<?=$guncelle_dizi['resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/subeler/".$guncelle_dizi['resim']);
						}
						}
					?>
				</div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/subeler/<?=$guncelle_dizi['banner_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill_banner"]){
							 unlink("../lib/images/subeler/".$guncelle_dizi['banner_resim']);
						}
						}
					?>
				</div>
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Google Maps (Harita) </label>
                  <textarea  class="form-control" name="google_maps" style="height:150px; border:2px solid #ccc"><?=$guncelle_dizi['google_maps']?></textarea>
                </div>
                
                
     <!--   <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama</label>
        ...
        <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Şube Açıklama Almanca</label>
