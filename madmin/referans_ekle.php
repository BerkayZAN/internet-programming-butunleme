...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$klasor_banner="../lib/images/referanslar/";
...
if(empty($adi)){
	...
	$query=$db->prepare("insert into referanslar set
		sira	= :sira,
		kategori= :kategori,
		adi		= :adi,
		adi_en	= :adi_en,
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	else
	{
		if ($_FILES["resim"]["type"] =="image/gif" || $_FILES["resim"]["type"] =="image/png"|| $_FILES["resim"]["type"] =="image/jpg"|| $_FILES["resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/referanslar/".$ayar_kaydi['resim']);	  
			}
	...
	else
	{
		if ($_FILES["banner_resim"]["type"] =="image/gif" || $_FILES["banner_resim"]["type"] =="image/png"|| $_FILES["banner_resim"]["type"] =="image/jpg"|| $_FILES["banner_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/referanslar/".$ayar_kaydi['banner_resim']);	  
			}
...
{
	$id=$_GET['id'];	
	$guncelle_dizi = $db->query("SELECT * FROM referanslar Where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html>
          ...
          <div class="box box-primary col-md-12">
            ...
            <form role="form" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Sırası</label>
                ...
                <select class="form-control select2" name="kategori">
                 ...
                 <?php $kategori_cek=$db->query("select * from referans_kategori where ustid='0' order by sira asc",PDO::FETCH_ASSOC);
                ...
                <option style="background:#F2F2F2;" value="<?=$kategori_dizi['id']?>" <?php if($guncelle_dizi['kategori']==$kategori_dizi['id']) { ?> selected="selected" <?php } ?>><?=$kategori_dizi['kategori_adi']?></option>
                         ...
                         <?php $ustid = $kategori_dizi['id'];
						 		$kategori_cek1=$db->query("select * from referans_kategori where ustid='$ustid' order by sira asc",PDO::FETCH_ASSOC);
    ...
    <option value="<?=$kategori_dizii['id']?>" <?php if(@$kategori_dizii['id']==$guncelle_dizi['kategori']){?> selected="selected"<?php } ?>><span style="font-size:10px; color:#039;"> --> <?=$kategori_dizii['kategori_adi']?> - <?=$kategori_dizii['id']?></span></option>                      
        ...
        <?php }?>        
				...
				<div class="center col-md-12">
                    <div class="titlem">
                        <h1 class="h1s">REFERANS RESMİ</h1>
                    </div>
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/referanslar/<?=$guncelle_dizi['resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/referanslar/".$guncelle_dizi['resim']);
						}
						}
					?>
				</div>
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama</label>
           	  ...
           	  <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Referans Açıklama Almanca</label>
