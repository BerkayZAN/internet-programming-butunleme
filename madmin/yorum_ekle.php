...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	else
	{
		if ($_FILES["resim"]["type"] =="image/gif" || $_FILES["resim"]["type"] =="image/png"|| $_FILES["resim"]["type"] =="image/jpg"|| $_FILES["resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/yorumlar/".$ayar_kaydi['resim']);	  
			}
...
{
	$id=$_GET['id'];
	$guncelle_dizi = $db->query("SELECT * FROM yorumlar Where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html>
    ...
    <section class="content">
      <div class="row">
        ...
        <?php }?>  
                ...
                <div class="form-group col-md-12">
                  <p style="font-weight:bold;">Cinsiyet</p>
                <label style="padding-right:10px;">
                
                  Erkek <input type="radio" name="durum" value="0"  checked<?php if(@$guncelle_dizi['durum']==0){ ?> checked <?php }?>>
                </label>
                <label>
                
                  Kadın <input type="radio" name="durum" value="1" <?php if(@$guncelle_dizi['durum']==1){ ?> checked <?php }?>>
                </label>
              </div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/yorumlar/<?=$guncelle_dizi['resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/yorumlar/".$guncelle_dizi['resim']);
						}
						}
					?>
				</div>
                ...
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama</label>
        ...
        <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Yorum Açıklama Almanca</label>
