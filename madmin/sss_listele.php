...
if(isset($_GET['sil'])){
 $id=$_GET['sil'];
 $sonuc = $db->query("DELETE FROM  sss where id='$id'");
          ...
          <div class="box">
            ...
            <div class="box-body" style="overflow-x:auto;">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                	$sorgu=$db->query("select * from sss order by id desc");
					if($sorgu->rowCount()){
				...
				?>
                    <tr>
                     ...
                     <a href='sss_ekle.php?islem=duzenle&id=<?=$sonuc['id']?>' class='btn btn-primary m-r1em'>Düzenle</a>
