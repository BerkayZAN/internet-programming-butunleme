...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$klasor="../lib/images/haber_kategori/";
	...
	$klasor_banner="../lib/images/haber_kategori/";
...
if(empty($kategori_adi)){
	...
	$query=$db->prepare("insert into haber_kategori set
		sira				= :sira,
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	{
		$duzenlenecek_id = $_GET['id'];
		$ayar_kaydi = $db->query("SELECT * FROM haber_kategori WHERE id = '$duzenlenecek_id'")->fetch(PDO::FETCH_ASSOC);
	...
	else
	{
		if ($_FILES["kategori_resim"]["type"] =="image/gif" || $_FILES["kategori_resim"]["type"] =="image/png"|| $_FILES["kategori_resim"]["type"] =="image/jpg"|| $_FILES["kategori_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/haber_kategori/".$ayar_kaydi['kategori_resim']);	  
			}
	...
	$update = $db->prepare("UPDATE haber_kategori SET 
						sira				= :sira,
						kategori_adi		= :kategori_adi,
						site_title			= :site_title,
						site_description	= :site_description,
...
{
	$id=$_GET['id'];
	$guncelle_dizi = $db->query("SELECT * FROM haber_kategori where id='$id'")->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="">Haber Kategori Ekle</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary col-md-12">
            <div class="box-header with-border">
              <h3 class="box-title">Haber Kategori Ekle</h3>
              <?=$bilgi?>
            </div>            
            ...
            <div class="tab-content col-md-12">
             ...
             <div class="tab-pane active" id="tab_1">
                ...
                <select class="form-control select2" name="ustid">
                 ...
                 <?php $kategori_cek=$db->query("select * from haber_kategori where ustid='0' order by sira asc",PDO::FETCH_ASSOC);
				 ...
				 ?>
                  <option value="<?=$kategori_dizi['id']?>" <?php if($kategori_dizi['id']==$guncelle_dizi['ustid']) { ?> selected="selected" <?php } ?>><?=$kategori_dizi['kategori_adi']?></option>
                         ...
                         <?php $ustid = $kategori_dizi['id'];
						 		$kategori_cek1=$db->query("select * from haber_kategori where ustid='$ustid' order by sira asc",PDO::FETCH_ASSOC);
    ...
    <option value="<?=$kategori_dizii['id']?>" <?php if($kategori_dizii['id']==$guncelle_dizi['ustid']){?> selected="selected"<?php } ?>><span style="font-size:10px; color:#039;"> --> <?=$kategori_dizii['kategori_adi']?> - <?=$kategori_dizii['id']?></span></option>                      
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/haber_kategori/<?=$guncelle_dizi['kategori_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/haber_kategori/".$guncelle_dizi['kategori_resim']);
						}
						}
					?>
				</div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/haber_kategori/<?=$guncelle_dizi['banner_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill_banner"]){
							 unlink("../lib/images/haber_kategori/".$guncelle_dizi['banner_resim']);
						}
						}
					?>
				</div>
        ...
        <?php if($yonetici_izin["en"]==1){?>   
              	<div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Haber Kategori Açıklama İngilizce</label>
        ...
        <?php if($yonetici_izin["fr"]==1){?>       
              	<div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Haber Kategori Açıklama Fransızca</label>
        ...
        <?php if($yonetici_izin["ar"]==1){?>      
                <div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Haber Kategori Açıklama Arapça</label>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Haber Kategori Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-10">
                  <label for="exampleInputEmail1">Haber Kategori Açıklama Almanca</label>
