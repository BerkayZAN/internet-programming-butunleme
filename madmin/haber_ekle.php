...
if($_POST['gonder'] and $_GET['islem']==""){
	...
	$klasor_banner="../lib/images/haberler/";
...
if(@$_POST['gonder'] and $_GET['islem']=="duzenle" )
{
	...
	else
	{
		if ($_FILES["resim"]["type"] =="image/gif" || $_FILES["resim"]["type"] =="image/png"|| $_FILES["resim"]["type"] =="image/jpg"|| $_FILES["resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/haberler/".$ayar_kaydi['resim']);	  
			}
	...
	else
	{
		if ($_FILES["banner_resim"]["type"] =="image/gif" || $_FILES["banner_resim"]["type"] =="image/png"|| $_FILES["banner_resim"]["type"] =="image/jpg"|| $_FILES["banner_resim"]["type"] =="image/jpeg") 
		{
			...
			{
			  unlink("../lib/images/haberler/".$ayar_kaydi['banner_resim']);	  
			}
...
$id_bul = $db->query("SELECT * FROM haberler order by id desc LIMIT 1")->fetch(PDO::FETCH_ASSOC);
$idim=$id_bul['id']+1;
?>
<!DOCTYPE html>
<html>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-primary col-md-12">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="dr "><a href="#tab_2" data-toggle="tab">Haber Resimleri</a></li>
    ...
    <option value="<?=$kategori_dizii['id']?>" <?php if(@$kategori_dizii['id']==$guncelle_dizi['kategori']){?> selected="selected"<?php } ?>><span style="font-size:10px; color:#039;"> --> <?=$kategori_dizii['kategori_adi']?> - <?=$kategori_dizii['id']?></span></option>                      
        ...
        <?php if($yonetici_izin["ru"]==1){?>         
				<div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Haber Adı Rusça</label>
                  <input type="text" class="form-control" name="adi_ru" value="<?=$guncelle_dizi['adi_ru']?>" >
                </div>
        <?php }?>
        <?php if($yonetici_izin["de"]==1){?>        
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Haber Adı Almanca</label>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/haberler/<?=$guncelle_dizi['resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill"]){
							 unlink("../lib/images/haberler/".$guncelle_dizi['resim']);
						}
						}
					?>
				</div>
				...
				<div class="center col-md-12">
                    ...
                    <div class="dropzone">
                     <?php if($_GET['islem']=="duzenle"){
						 ...
						 ?>
                        <img src="../lib/images/haberler/<?=$guncelle_dizi['banner_resim']?>" class="upload-icon" style="width:170px; height:170px;"/>	 <?php }}else{?>
                    ...
                    <?php 
						if($_GET['islem']=="duzenle"){
							...
							if($_POST["sill_banner"]){
							 unlink("../lib/images/haberler/".$guncelle_dizi['banner_resim']);
						}
						}
					?>
				</div>
        ...
        <?php if($yonetici_izin["ru"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Haber Açıklama Rusça</label>
        ...
        <?php if($yonetici_izin["de"]==1){?>      
			    <div class="form-group col-md-12">
                  <label for="exampleInputEmail1">Haber Açıklama Almanca</label>
