...
$id=$_GET['id'];
$urndetay=$db->query("select * from urunler where id='$id'")->fetch(PDO::FETCH_ASSOC);
?>
...
<title><?=$urndetay['adi']?> - <?=$ayar['site_title']?></title>
...
<div class="subheader normal-bg section-padding">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h1 class="text-custom-white"><?=$urndetay['adi']?></h1>
        <ul class="custom-flex justify-content-center">
          <li class="fw-500"> <a href="./" class="text-custom-white">Anasayfa</a> </li>
          <li class="active fw-500"> <?=$urndetay['adi']?> </li>
        </ul>
      </div>
    </div>
  </div>
        ...
        <div class="blog-details bx-wrapper bg-custom-white padding-20">
          <article class="post p-relative">
            <div class="post-wrapper">
              <div class="post-img animate-img mb-xl-20"> <img src="lib/images/urunler/<?=$urndetay['resim']?>" class="image-fit" alt="img"> </div>
              <div class="blog-meta bg-custom-white">
               
                <div class="post-heading p-relative">
                  <h2><a href="#" class="text-custom-black"><?=$urndetay['adi']?></a></h2>
                </div>
               
                <p class="text-light-dark"><?=$urndetay['aciklama']?></p>
              </div>
            </div>
          </article>
          <hr>
